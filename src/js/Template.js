...
const Template = () => {
    ...
    const more = ({ width = 24, height = 24, color = '#ccc' }) => `
    ...
    const boards = ({ width = 24, height = 24, color = '#ccc' }) => `
        <svg xmlns="http://www.w3.org/2000/svg" height="${height}" viewBox="0 0 24 24" width="${width}" fill="${color}">
            <path d="M0 0h24v24H0z" fill="none"/>
            <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/>
        </svg>
    ...
    const home = ({ width = 24, height = 24, color = '#ccc' }) => `
        <svg xmlns="http://www.w3.org/2000/svg" height="${height}" viewBox="0 0 24 24" width="${width}" fill="${color}">
    ...
    const temp = ({ width = 24, height = 24, color ='#ccc' }) => `
        <svg xmlns="http://www.w3.org/2000/svg" height="${height}" viewBox="0 0 24 24" width="${width}" fill="${color}">
            <path d="M0 0h24v24H0z" fill="none"/>
